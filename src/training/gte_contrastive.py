...
args = SentenceTransformerTrainingArguments(
    output_dir=f"checkpoints/gte-contrastive",
    num_train_epochs=3,
    ...
    save_total_limit=2,
    logging_steps=50,
    run_name="gte-contrastive",
    seed=SEED,
    logging_dir="./runs/gte-contrastive",
...
trainer.save_model(f"checkpoints/gte-contrastive/best-model")

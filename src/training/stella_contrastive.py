...
args = SentenceTransformerTrainingArguments(
    output_dir=f"checkpoints/stella-contrastive",
    num_train_epochs=3,
    ...
    seed=SEED,
    logging_dir="./runs/stella-contrastive",
...
trainer.evaluate(dataset_dict["test"], binary_acc_evaluator)

trainer.save_model(f"checkpoints/stella-contrastive/best-model")

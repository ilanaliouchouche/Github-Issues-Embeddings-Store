...
args = SentenceTransformerTrainingArguments(
    output_dir=f"checkpoints/e5-onlinecontrastive",
    num_train_epochs=3,
    ...
    save_total_limit=2,
    logging_steps=50,
    run_name="e5-onlinecontrastive",
    seed=SEED,
    logging_dir="./runs/e5-onlinecontrastive",
...
trainer.save_model(f"checkpoints/e5-onlinecontrastive/best-model")
